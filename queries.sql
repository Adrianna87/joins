...
--first_name, last_name and count of vehicles. --
...
-- Display the owners first_name, last_name, average price --
-- and count of vehicles. The first_name should be ordered --
-- in descending order. Only display results with more than --
